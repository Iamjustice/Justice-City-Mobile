class ApiEndpoints {
  ...
  static String deleteListing(String listingId) =>
      '/api/agent/listings/$listingId';
  ...
  // Chat
  static String chatCards(String userId) => '/api/chat-cards/$userId';
  ...
  static String adminHiringStatus(String id) =>
      '/api/admin/hiring-applications/$id/status';
  static String adminServiceOffering(String code) =>
      '/api/admin/service-offerings/$code';
  ...
  static String adminFlaggedListingStatus(String id) =>
      '/api/admin/flagged-listings/$id/status';
  static String adminFlaggedListingComments(String id) =>
      '/api/admin/flagged-listings/$id/comments';
  ...
  static const verificationDocumentsUpload =
  ...
  static String transactionByConversation(String conversationId) =>
      '/api/transactions/by-conversation/$conversationId';
